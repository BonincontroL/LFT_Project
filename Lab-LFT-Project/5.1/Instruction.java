public class Instruction {   //La classe se Instruction verrà usata per rappresentare singole istruzioni del linguaggio mnemonico
    OpCode opCode;          
    int operand;
    ...
    public String toJasmin () {          //metodo toJasmin restituisce l’istruzione nel formato adeguato per l’assembler Jasmin
        String temp="";
        switch (opCode) {
